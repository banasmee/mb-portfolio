      ...
      <AnimatePresence>
        ...
        >
          <div className="lg:ml-12 text-center lg:text-left pb-20">
            ...
            <h2 className="text-2xl lg:text-3xl xl:text-[2.625rem] font-normal leading-normal uppercase">Web Developer</h2>
            <p className="text-md lg:text-xl max-w-xl mt-4">Cześć! Zajmuję się tworzeniem stron internetowych, a&nbsp;także ich projektowaniem. Wciąż się uczę -&nbsp;aktualnie poznaję frameworki React oraz&nbsp;Next.js</p>
          </div>
        </motion.div>
      </AnimatePresence>
    </main>
